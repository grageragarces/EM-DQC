...
rz(pi/2) eval[0];
sx eval[0];
rz(-2.237957729267354) eval[0];
rz(pi/2) eval[1];
sx eval[1];
rz(1.5708023189073492) eval[1];
rz(pi/2) eval[2];
sx eval[2];
rz(1.5708083110198021) eval[2];
rz(pi/2) eval[3];
sx eval[3];
rz(1.5708202952447075) eval[3];
rz(pi/2) eval[4];
sx eval[4];
rz(1.5708442636945181) eval[4];
rz(pi/2) eval[5];
sx eval[5];
rz(1.5708922005941395) eval[5];
rz(pi/2) eval[6];
sx eval[6];
rz(1.5709880743933822) eval[6];
rz(pi/2) eval[7];
sx eval[7];
rz(1.571179821991868) eval[7];
rz(pi/2) eval[8];
sx eval[8];
rz(1.5715633171888392) eval[8];
rz(pi/2) eval[9];
sx eval[9];
rz(1.5723303075827821) eval[9];
rz(pi/2) eval[10];
sx eval[10];
rz(1.573864288370668) eval[10];
rz(pi/2) eval[11];
sx eval[11];
rz(1.576932249946439) eval[11];
rz(pi/2) eval[12];
sx eval[12];
rz(1.5830681730979819) eval[12];
rz(pi/2) eval[13];
sx eval[13];
rz(1.595340019401067) eval[13];
rz(pi/2) eval[14];
sx eval[14];
rz(1.6198837120072371) eval[14];
rz(pi/2) eval[15];
sx eval[15];
rz(1.6689710972195775) eval[15];
rz(pi/2) eval[16];
sx eval[16];
rz(9*pi/16) eval[16];
rz(pi/2) eval[17];
