...
rz(pi/2) eval[0];
sx eval[0];
rz(0.2829004656164633) eval[0];
rz(pi/2) eval[1];
sx eval[1];
rz(1.5723303075827821) eval[1];
rz(pi/2) eval[2];
sx eval[2];
rz(1.573864288370668) eval[2];
rz(pi/2) eval[3];
sx eval[3];
rz(1.576932249946439) eval[3];
rz(pi/2) eval[4];
sx eval[4];
rz(1.5830681730979819) eval[4];
rz(pi/2) eval[5];
sx eval[5];
rz(1.595340019401067) eval[5];
rz(pi/2) eval[6];
sx eval[6];
rz(1.6198837120072371) eval[6];
rz(pi/2) eval[7];
sx eval[7];
rz(1.6689710972195775) eval[7];
rz(pi/2) eval[8];
sx eval[8];
rz(9*pi/16) eval[8];
rz(pi/2) eval[9];
