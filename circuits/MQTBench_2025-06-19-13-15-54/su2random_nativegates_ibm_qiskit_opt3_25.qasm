...
sx q[21];
rz(0.9784599817592978) q[21];
cx q[22],q[24];
sx q[22];
rz(0.6481920941812596) q[22];
sx q[22];
rz(1.9073761822649802) q[22];
cx q[23],q[24];
sx q[23];
